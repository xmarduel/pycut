...
class ShapelyUtils:
    ...
    def offsetMultiPolygon(cls, geometry: shapely.geometry.MultiPolygon, amount: float, side, consider_interiors_offsets=False, resolution=16, join_style=1, mitre_limit=5.0) -> shapely.geometry.MultiPolygon:
        ...
        return offsetser.offset(amount, side, consider_interiors_offsets, resolution, join_style, mitre_limit)

    @classmethod
    def offsetMultiPolygonInteriors(cls, geometry: shapely.geometry.MultiPolygon, amount: float, side, consider_exteriors_offsets=False, resolution=16, join_style=1, mitre_limit=5.0) -> shapely.geometry.MultiPolygon | None:
        '''
        Generate offseted polygons.
        '''
        ...
        return offsetser.offset(amount, side, consider_exteriors_offsets, resolution, join_style, mitre_limit)
