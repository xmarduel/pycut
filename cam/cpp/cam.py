...
def hspocket(paths, numPaths, pathSizes, cutterDia, resultPaths, resultNumPaths, resultPathSizes):
    return _cam.hspocket(paths, numPaths, pathSizes, cutterDia, resultPaths, resultNumPaths, resultPathSizes)

def vPocket(debugArg0, debugArg1, paths, numPaths, pathSizes, cutterAngle, passDepth, maxDepth, resultPaths, resultNumPaths, resultPathSizes):
    return _cam.vPocket(debugArg0, debugArg1, paths, numPaths, pathSizes, cutterAngle, passDepth, maxDepth, resultPaths, resultNumPaths, resultPathSizes)

def separateTabs(pathPolygons, numPaths, pathSizes, tabPolygons, numTabPolygons, tabPolygonSizes, error, resultPaths, resultNumPaths, resultPathSizes):
    return _cam.separateTabs(pathPolygons, numPaths, pathSizes, tabPolygons, numTabPolygons, tabPolygonSizes, error, resultPaths, resultNumPaths, resultPathSizes)
