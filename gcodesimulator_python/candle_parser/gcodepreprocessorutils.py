...
class GcodePreprocessorUtils:
    ...
    def updatePointWithCommand_FromStringList(
        cls, commandArgs: List[str], initial: QVector3D, absoluteMode: bool
    ) -> QVector3D:
        """
    ...
    @classmethod
    def updatePointWithCommand_FromVector3D(
        cls, initial: QVector3D, x: float, y: float, z: float, absoluteMode: bool
    ) -> QVector3D:
        """
    ...
    @classmethod
    def generatePointsAlongArcBDring(
        cls,
        plane: PointSegment.Plane,
        start: QVector3D,
        end: QVector3D,
        center: QVector3D,
        clockwise: bool,
    ...
    @classmethod
    def generatePointsAlongArcBDring_Num(
        cls,
        plane: PointSegment.Plane,
        p1: QVector3D,
        p2: QVector3D,
