...
class SvgPath_SvgElements:
    ...
    PYCUT_SAMPLE_LEN_COEFF = (
        10  # 10 # 10 points per "svg unit" ie arc of len 10 -> 100 pts discretization
    )
    ...
    def read_paths_from_file(cls, svgfilename) -> List["SvgPath_SvgElements"]:
        svg = svgelements.SVG.parse(
            svgfilename, reify=True, ppi=25.4
...
def main():
    ...
    svgfilename = (
        "C:\\Users\\xavie\\Documents\\GITHUB\\pycut\\misc_private\svg\\two_circles.svg"
    )
