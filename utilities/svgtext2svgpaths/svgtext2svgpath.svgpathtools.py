        ...
        for i in range(len(outline.contours)):
            ...
            for k, segment in enumerate(segments):
                ...
                if len(segment) == 2:
                    ...
                    path_segments.append(QuadraticBezier(start=tuple2complex(P1), control=tuple2complex(C12), end=tuple2complex(P2)))
                    ...
                    path_segments.append(QuadraticBezier(start=tuple2complex(P1), control=tuple2complex(C12), end=tuple2complex(P2)))
                    path_segments.append(QuadraticBezier(start=tuple2complex(P2), control=tuple2complex(C23), end=tuple2complex(P3)))
                    ...
                    path_segments.append(QuadraticBezier(start=tuple2complex(P1), control=tuple2complex(C12), end=tuple2complex(P2)))
                    path_segments.append(QuadraticBezier(start=tuple2complex(P2), control=tuple2complex(C23), end=tuple2complex(P3)))
                    path_segments.append(QuadraticBezier(start=tuple2complex(P3), control=tuple2complex(C34), end=tuple2complex(P4)))
                    ...
                    path_segments.append(QuadraticBezier(start=tuple2complex(Ps), control=tuple2complex(Ctrl), end=tuple2complex(Pe)))
